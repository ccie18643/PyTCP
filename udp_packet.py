...
class UdpPacket:
    ...
    def __init__(self, local_ipv4_address, local_port, remote_ipv4_address, remote_port, raw_data, tracker):
    ...
    def socket_id_patterns(self):
        ...
        return [
            f"UDP/{self.local_ipv4_address}/{self.local_port}/{self.remote_ipv4_address}/{self.remote_port}",
            f"UDP/{self.local_ipv4_address}/{self.local_port}/0.0.0.0/0",
