    ...
    while True:
        ...
        if ethernet_packet_in.ethertype == ph_ethernet.ETHERTYPE_ARP:
            ...
            if arp_packet_in.operation == ph_arp.ARP_OP_REQUEST:
                logger.info(f"Dequeued ARP request for {arp_packet_in.tpa} ({arp_packet_in.tha}) from {arp_packet_in.spa} ({arp_packet_in.sha})")
                ...
                if arp_packet_in.tpa == STACK_IP_ADDRESS:
                    ...
                    logger.info(f"Enqueued ARP reply for {arp_packet_out.spa} ({arp_packet_out.sha}) to {arp_packet_out.tpa} ({arp_packet_out.tha})")
