...
class TestPacketHandler(TestCase):
    def setUp(self):
        ...
        # Assembled packet result is usually taken from 'self.packet_tx', bellow list is used only for tx fragmentation test
        ...
        self.mock_callable(self.tx_ring_mock, "enqueue").with_implementation(
            lambda _: _.assemble(self.packet_tx) or self.packets_tx.append(self.packet_tx)
        )
