    ...
    def test__parse_stack_ip6_address_candidate(self) -> None:
        ...
        sample = [
            (
                "FE80::7/64",
                None,
            ),  # valid link loal address [pass]
            (
                "FE80::77/64",
                None,
            ),  # valid link local address [pass]
            (
                "FE80::7777/64",
                None,
            ),  # valid link local address [pass]
            (
                "FE80::7777/64",
                None,
            ),  # valid duplicated address [fail]
            (
                "FE80::9999/64",
                "FE80::1",
            ),  # valid link local address with default gateway [fail]
            (
                "2007::1111/64",
                "DUPA",
            ),  # valid global address with malformed gateway [fail]
            (
                "ZHOPA",
                None,
            ...
            (
                "2015::15/64",
                None,
            ),  # valid global address with no gateway [pass]
        ]
        expected = [
            Ip6Host("fe80::7/64"),
            Ip6Host("fe80::77/64"),
    ...
    def test_parse_stack_ip4_host_candidate(self) -> None:
        sample = [
            (
                "192.168.9.7/24",
                "192.168.9.1",
            ),  # valid address and valid gateway [pass]
            (
                "192.168.9.77/24",
                "192.168.9.1",
            ),  # valid address and valid gateway [pass]
            ...
            (
                "192.168.9.99/24",
                "DUPA",
            ),  # malformed gateway [fail]
            (
                "192.168.9.77/24",
                "192.168.9.1",
            ),  # duplicate address [fail]
            (
                "192.168.9.170/24",
                "10.0.0.1",
            ),  # valid address but invalid gateway [fail]
            (
                "192.168.9.171/24",
                "192.168.9.0",
            ),  # valid address but test invalid gateway [fail]
            (
                "192.168.9.172/24",
                "192.168.9.172",
            ),  # valid address but invalid gateway [fail]
            ...
            (
                "192.168.9.102/24",
                None,
            ),  # valid address and no gateway [pass]
            (
                "172.16.17.7/24",
                "172.16.17.1",
            ),  # valid address and valid gateway [pass]
        ...
        expected = [
            ...
            Ip4Address("192.168.9.1"),
            None,
            Ip4Address("172.16.17.1"),
            Ip4Address("10.10.10.1"),
        ]
