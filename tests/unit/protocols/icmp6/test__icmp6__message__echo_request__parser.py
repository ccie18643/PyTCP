...
"""
This module contains tests for the ICMPv6 Echo Request message parser.
    ...
    [
        {
            ...
            "_results": {
                "from_bytes": Icmp6EchoRequestMessage(
                    cksum=0,
                    id=12345,
                    seq=54321,
                    data=b"",
        ...
        },
        {
            ...
            "_args": {
                "bytes": b"\x80\x00\x00\x00\x2b\x67\x56\xce" + b"X" * 65527,
            },
            "_results": {
                "from_bytes": Icmp6EchoRequestMessage(
                    cksum=0,
        ...
        {
            "_description": "ICMPv6 Echo Request message, incorrect 'type' field.",
            "_args": {
...
class TestIcmp6MessageEchoRequestParser(TestCase):
    ...
    def test__icmp6__message__echo_request__parser__from_bytes(self) -> None:
        """
        Ensure the ICMPv6 'Echo Request' message 'from_bytes()' method
        creates a proper message object.
        """

        if "error" in self._results:
            with self.assertRaises(AssertionError) as error:
                Icmp6EchoRequestMessage.from_bytes(self._args["bytes"])
