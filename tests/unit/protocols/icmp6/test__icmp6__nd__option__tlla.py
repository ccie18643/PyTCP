...
"""
This module contains tests for the ICMPv6 ND Tlla (Target Link Layer Address) option code.
...
class TestIcmp6NdOptionTllaAsserts(TestCase):
    ...
    def test__icmp6__nd__option__tlla__tlla__not_MacAddress(self) -> None:
        """
        Ensure the ICMPv6 ND Tlla option constructor raises an exception when the provided
        'tlla' argument is not a MacAddress.
        """
...
@parameterized_class(
    [
        {
            "_description": "The ICMPv6 ND Tlla option.",
            "_args": {
...
class TestIcmp6NdOptionTllaAssembler(TestCase):
    ...
    def test__icmp6__nd__option__tlla__len(self) -> None:
        """
        Ensure the ICMPv6 ND Tlla option '__len__()' method returns a correct value.
        """
    ...
    def test__icmp6__nd__option__tlla__str(self) -> None:
        """
        Ensure the ICMPv6 ND Tlla option '__str__()' method returns a correct value.
        """
    ...
    def test__icmp6__nd__option__tlla__repr(self) -> None:
        """
        Ensure the ICMPv6 ND Tlla option '__repr__()' method returns a correct value.
        """
    ...
    def test__icmp6__nd__option__tlla__bytes(self) -> None:
        """
        Ensure the ICMPv6 ND Tlla option '__bytes__()' method returns a correct value.
        """
    ...
    def test__icmp6__nd__option__tlla__tlla(self) -> None:
        """
        Ensure the ICMPv6 ND Tlla option 'mss' property returns a correct value.
        """
    ...
    [
        ...
        },
        {
            ...
            "_results": {
                ...
                "error_message": "Invalid ND Tlla option length (I).",
            },
        },
        {
            ...
            "_results": {
                "error": Icmp6IntegrityError,
                "error_message": "Invalid ND Tlla option length (II).",
            },
        },
    ]
)
