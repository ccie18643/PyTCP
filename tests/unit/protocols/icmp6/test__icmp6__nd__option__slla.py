...
"""
This module contains tests for the ICMPv6 ND Slla (Source Link Layer Address) option code.
...
class TestIcmp6NdOptionSllaAsserts(TestCase):
    ...
    def test__icmp6__nd__option__slla__slla__not_MacAddress(self) -> None:
        """
        Ensure the ICMPv6 ND Slla option constructor raises an exception when the provided
        'slla' argument is not a MacAddress.
        """
