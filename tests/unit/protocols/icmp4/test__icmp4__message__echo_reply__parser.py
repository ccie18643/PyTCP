...
"""
This module contains tests for the ICMPv4 Echo Reply message parser.

tests/unit/protocols/icmp4/test__icmp4__message__echo_reply__parser.py
    ...
    [
        {
            ...
            "_results": {
                "from_bytes": Icmp4EchoReplyMessage(
                    cksum=0,
                    id=12345,
                    seq=54321,
                    data=b"",
        ...
        },
        {
            ...
            "_args": {
                "bytes": b"\x00\x00\x00\x00\x2b\x67\x56\xce" + b"X" * 65507,
            },
            "_results": {
                "from_bytes": Icmp4EchoReplyMessage(
                    cksum=0,
        ...
        {
            "_description": "ICMPv4 Echo Reply message, incorrect 'type' field.",
            "_args": {
    ...
    def test__icmp4__message__echo_reply__parser__from_bytes(self) -> None:
        ...
        if "error" in self._results:
            with self.assertRaises(AssertionError) as error:
                Icmp4EchoReplyMessage.from_bytes(self._args["bytes"])
