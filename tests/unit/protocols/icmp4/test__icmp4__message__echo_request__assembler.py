    ...
    [
        {
            ...
            "_results": {
                ...
                "__bytes__": b"\x08\x00\x00\x00\x30\x39\xd4\x31",
        ...
        },
        {
            ...
            "_results": {
                ...
                "__bytes__": (
                    b"\x08\x00\x00\x00\x2b\x67\x56\xce" + b"X" * 65507
                ),
                "type": Icmp4Type.ECHO_REQUEST,
                "code": Icmp4EchoRequestCode.DEFAULT,
                "cksum": 33333,
...
class TestIcmp4MessageEchoRequestPackets(TestCase):
    """
    ...
    def test__icmp4__message__echo_request__assembler__len(self) -> None:
        ...
        self.assertEqual(
            len(self._icmp4__echo_request__message),
    ...
    def test__icmp4__message__echo_request__assembler__str(self) -> None:
        ...
        self.assertEqual(
            str(self._icmp4__echo_request__message),
    ...
    def test__icmp4__message__echo_request__assembler__repr(self) -> None:
        ...
        self.assertEqual(
            repr(self._icmp4__echo_request__message),
    ...
    def test__icmp4__message__echo_request__assembler__bytes(self) -> None:
        ...
        self.assertEqual(
            bytes(self._icmp4__echo_request__message),
    ...
    def test__icmp4__message__echo_request__assembler__type(self) -> None:
        ...
        self.assertEqual(
            self._icmp4__echo_request__message.type,
            self._results["type"],
        )
    ...
    def test__icmp4__message__echo_request__assembler__code(self) -> None:
        ...
        self.assertEqual(
            self._icmp4__echo_request__message.code,
            self._results["code"],
        )
    ...
    def test__icmp4__message__echo_request__assembler__cksum(self) -> None:
        ...
        self.assertEqual(
            self._icmp4__echo_request__message.cksum,
            self._results["cksum"],
        )
    ...
    def test__icmp4__message__echo_request__assembler__id(self) -> None:
        ...
        self.assertEqual(
            self._icmp4__echo_request__message.id,
            self._results["id"],
        )
    ...
    def test__icmp4__message__echo_request__assembler__seq(self) -> None:
        ...
        self.assertEqual(
            self._icmp4__echo_request__message.seq,
            self._results["seq"],
        )
    ...
    def test__icmp4__message__echo_request__assembler__data(self) -> None:
        ...
        self.assertEqual(
            self._icmp4__echo_request__message.data,
            self._results["data"],
        )
