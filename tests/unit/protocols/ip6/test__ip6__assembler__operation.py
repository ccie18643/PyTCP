    ...
    [
        {
            ...
            "_results": {
                ...
                "__repr__": (
                    "Ip6Assembler(header=Ip6Header(ver=6, dscp=0, ecn=0, flow=0, dlen=0, "
        ...
        },
        {
            ...
            "_results": {
                ...
                "__repr__": (
                    "Ip6Assembler(header=Ip6Header(ver=6, dscp=38, ecn=2, flow=1048575, dlen=16, "
        ...
        },
        {
            ...
            "_results": {
                ...
                "__repr__": (
                    "Ip6Assembler(header=Ip6Header(ver=6, dscp=63, ecn=3, flow=0, dlen=65495, "
