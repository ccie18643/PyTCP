...
def _phrx_icmp6(self, packet_rx):
    ...
    if packet_rx.icmp6.type == ps.icmp6.NEIGHBOR_SOLICITATION:
        ...
        self._phtx_icmp6(
            ...
            ip6_hop=255,
            icmp6_type=ps.icmp6.NEIGHBOR_ADVERTISEMENT,
            ...
            icmp6_nd_options=[fpa.icmp6.NdOptTLLA(self.mac_unicast)],
            echo_tracker=packet_rx.tracker,
        )
        return

    # ICMPv6 Neighbor Advertisement packet
    if packet_rx.icmp6.type == ps.icmp6.NEIGHBOR_ADVERTISEMENT:
    ...
    if packet_rx.icmp6.type == ps.icmp6.ROUTER_SOLICITATION:
    ...
    if packet_rx.icmp6.type == ps.icmp6.ROUTER_ADVERTISEMENT:
    ...
    if packet_rx.icmp6.type == ps.icmp6.ECHO_REQUEST:
        if __debug__:
        ...
        self._phtx_icmp6(
            ...
            ip6_hop=255,
            icmp6_type=ps.icmp6.ECHO_REPLY,
