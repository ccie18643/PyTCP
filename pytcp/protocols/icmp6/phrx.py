...
class PacketHandlerRxIcmp6(ABC):
    """
    ...
    def _phrx_icmp6(self, *, packet_rx: PacketRx) -> None:
        ...
        for message, handler in {
            Icmp6PortUnreachableMessage: self.__phrx_icmp6__port_unreachable,
    ...
    def __phrx_icmp6__port_unreachable(self, *, packet_rx: PacketRx) -> None:
        """
        Handle inbound ICMPv6 Port Unreachbale packets.
        """

        assert isinstance(packet_rx.icmp6, Icmp6PortUnreachableMessage)
    ...
    def __phrx_icmp6__echo_request(self, *, packet_rx: PacketRx) -> None:
        ...
        self._phtx_icmp6(
            ...
            ip6__hop=255,
            icmp6__message=Icmp6EchoReplyMessageAssembler(
    ...
    def __phrx_icmp6__nd_router_advertisement(
        ...
        self.icmp6_ra_prefixes = [
            (opt, packet_rx.ip6.src) for opt in packet_rx.icmp6.message.opt_pi
        ]
    ...
    def __phrx_icmp6__nd_neighbor_solicitation(
        ...
        self._phtx_icmp6(
            ...
            if ip6_nd_dad
            else packet_rx.ip6.src,  # use ff02::1 destination addriess when responding to DAD request
            ip6__hop=255,
            icmp6__message=Icmp6NdNeighborAdvertisementMessageAssembler(
