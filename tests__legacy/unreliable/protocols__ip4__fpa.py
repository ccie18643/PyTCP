...
from pytcp.protocols.ip4.ip4__base import (
    IP4__HEADER__LEN,
    IP4_OPT_EOL_LEN,
    IP4_OPT_NOP_LEN,
    IP4_PROTO_ICMP4,
...
class TestIp4Assembler(TestCase):
    ...
    def test_ip4_fpa____init__(self) -> None:
        ...
        self.assertEqual(
            packet._hlen, IP4__HEADER__LEN + IP4_OPT_NOP_LEN + IP4_OPT_EOL_LEN
        )
        self.assertEqual(
            packet._plen,
    ...
    def test_ip4_fpa____init____defaults(self) -> None:
        ...
        self.assertEqual(packet._flag_mf, False)
        self.assertEqual(packet._offset, 0)
        self.assertEqual(packet._ttl, IP4__DEFAULT_TTL)
        self.assertEqual(packet._src, Ip4Address())
        self.assertEqual(packet._dst, Ip4Address())
        self.assertEqual(packet._options, [])
        self.assertEqual(packet._proto, IP4_PROTO_RAW)
        self.assertEqual(packet._hlen, IP4__HEADER__LEN)
        self.assertEqual(packet._plen, IP4__HEADER__LEN)
    ...
    def test_ip4_fpa____len__(self) -> None:
        ...
        """
        packet = Ip4Assembler()
        self.assertEqual(len(packet), IP4__HEADER__LEN)
    ...
    def test_ip4_fpa____len____options(self) -> None:
        ...
        self.assertEqual(
            len(packet), IP4__HEADER__LEN + IP4_OPT_NOP_LEN + IP4_OPT_EOL_LEN
        )
    ...
    def test_ip4_fpa____len____data(self) -> None:
        ...
        self.assertEqual(len(packet), IP4__HEADER__LEN + 16)
    ...
    def test_ip4_fpa__hlen_getter__options(self) -> None:
        ...
        self.assertEqual(
            packet.hlen, IP4__HEADER__LEN + IP4_OPT_NOP_LEN + IP4_OPT_EOL_LEN
        )
