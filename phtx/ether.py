...
def _phtx_ether(self, child_packet, ether_src="00:00:00:00:00:00", ether_dst="00:00:00:00:00:00"):
    ...
    ether_packet_tx = fpa.ether.EtherPacket(src=ether_src, dst=ether_dst, child_packet=child_packet)
    ...
    if ether_packet_tx.type == fpa.ether.ETHER_TYPE_IP6:
    ...
    if ether_packet_tx.type == fpa.ether.ETHER_TYPE_IP4:
